import 'package:animation/feature/animated_fractionally_sizedbox/widget/widget.dart';
...
class AnimatedFractionallySizedBoxScreen extends StatelessWidget {
  const AnimatedFractionallySizedBoxScreen({Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedFractionallySizedBoxWidget(),
          ],
        ),
      ),
    );
